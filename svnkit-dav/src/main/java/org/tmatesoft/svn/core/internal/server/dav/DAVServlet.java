...
public class DAVServlet extends HttpServlet {
    ...
    static {
        OUR_STATUS_LINES.put(100, "100 Continue");
        OUR_STATUS_LINES.put(101, "101 Switching Protocols");
        OUR_STATUS_LINES.put(102, "102 Processing");
        OUR_STATUS_LINES.put(200, "200 OK");
        OUR_STATUS_LINES.put(201, "201 Created");
        OUR_STATUS_LINES.put(202, "202 Accepted");
        OUR_STATUS_LINES.put(203, "203 Non-Authoritative Information");
        OUR_STATUS_LINES.put(204, "204 No Content");
        OUR_STATUS_LINES.put(205, "205 Reset Content");
        OUR_STATUS_LINES.put(206, "206 Partial Content");
        OUR_STATUS_LINES.put(207, "207 Multi-Status");
        OUR_STATUS_LINES.put(300, "300 Multiple Choices");
        OUR_STATUS_LINES.put(301, "301 Moved Permanently");
        OUR_STATUS_LINES.put(302, "302 Found");
        OUR_STATUS_LINES.put(303, "303 See Other");
        OUR_STATUS_LINES.put(304, "304 Not Modified");
        OUR_STATUS_LINES.put(305, "305 Use Proxy");
        OUR_STATUS_LINES.put(306, "306 unused");
        OUR_STATUS_LINES.put(307, "307 Temporary Redirect");
        OUR_STATUS_LINES.put(400, "400 Bad Request");
        OUR_STATUS_LINES.put(401, "401 Authorization Required");
        OUR_STATUS_LINES.put(402, "402 Payment Required");
        OUR_STATUS_LINES.put(403, "403 Forbidden");
        OUR_STATUS_LINES.put(404, "404 Not Found");
        OUR_STATUS_LINES.put(405, "405 Method Not Allowed");
        OUR_STATUS_LINES.put(406, "406 Not Acceptable");
        OUR_STATUS_LINES.put(407, "407 Proxy Authentication Required");
        OUR_STATUS_LINES.put(408, "408 Request Time-out");
        OUR_STATUS_LINES.put(409, "409 Conflict");
        OUR_STATUS_LINES.put(410, "410 Gone");
        OUR_STATUS_LINES.put(411, "411 Length Required");
        OUR_STATUS_LINES.put(412, "412 Precondition Failed");
        OUR_STATUS_LINES.put(413, "413 Request Entity Too Large");
        OUR_STATUS_LINES.put(414, "414 Request-URI Too Large");
        OUR_STATUS_LINES.put(415, "415 Unsupported Media Type");
        OUR_STATUS_LINES.put(416, "416 Requested Range Not Satisfiable");
        OUR_STATUS_LINES.put(417, "417 Expectation Failed");
        OUR_STATUS_LINES.put(418, "418 unused");
        OUR_STATUS_LINES.put(419, "419 unused");
        OUR_STATUS_LINES.put(420, "420 unused");
        OUR_STATUS_LINES.put(421, "421 unused");
        OUR_STATUS_LINES.put(422, "422 Unprocessable Entity");
        OUR_STATUS_LINES.put(423, "423 Locked");
        OUR_STATUS_LINES.put(424, "424 Failed Dependency");
        OUR_STATUS_LINES.put(425, "425 No code");
        OUR_STATUS_LINES.put(426, "426 Upgrade Required");
        OUR_STATUS_LINES.put(500, "500 Internal Server Error");
        OUR_STATUS_LINES.put(501, "501 Method Not Implemented");
        OUR_STATUS_LINES.put(502, "502 Bad Gateway");
        OUR_STATUS_LINES.put(503, "503 Service Temporarily Unavailable");
        OUR_STATUS_LINES.put(504, "504 Gateway Time-out");
        OUR_STATUS_LINES.put(505, "505 HTTP Version Not Supported");
        OUR_STATUS_LINES.put(506, "506 Variant Also Negotiates");
        OUR_STATUS_LINES.put(507, "507 Insufficient Storage");
        OUR_STATUS_LINES.put(508, "508 unused");
        OUR_STATUS_LINES.put(509, "509 unused");
        OUR_STATUS_LINES.put(510, "510 Not Extended");
    }
    ...
    public static String getStatusLine(int statusCode) {
        return (String) OUR_STATUS_LINES.get(statusCode);
    }
