...
public class Version {
    ...
    private static final String VERSION_STRING_DEFAULT = "SVN/1.8.1 SVNKit/1.10.10 (http://svnkit.com/) rSNAPSHOT";
    ...
    private static final String SVN_VERSION_DEFAULT = "1.10.10";
